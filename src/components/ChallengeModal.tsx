...
END:VCALENDAR`;
  ...
  const handleCopyYoutube = () => {
    navigator.clipboard.writeText('https://youtube.com/live/u42RK5eV_c8?feature=share');
    setCopied(true);
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <h3 className="text-2xl font-bold gold-text-gradient">
              Join FREE 5-Day 30-Minute Mental Reset
            </h3>
          ...
          <div className="space-y-2.5 pt-2 border-t border-[#1C6B63]/40">
            ...
            <div className="flex gap-2">
              ...
              <a
                href="https://youtube.com/live/u42RK5eV_c8?feature=share"
                target="_blank"
